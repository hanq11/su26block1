package com.example.sd22131jav201.bvbs.util;
...
public class HibernateConfigBvbs {
    ...
    static {
        ...
        properties.put(Environment.URL, "jdbc:sqlserver://localhost:1433;databaseName=SD22131JAV201;encrypt=true;trustServerCertificate=true;");
